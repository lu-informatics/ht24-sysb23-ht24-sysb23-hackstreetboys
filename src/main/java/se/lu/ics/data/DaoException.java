...
public static DaoException couldNotInsertEmployeeNo(Throwable cause) {
   return new DaoException("Could not insert EmployeeNo. EmployeeNo must start with 'E' followed by 0-4 digits (e.g., E1, E123).", cause);
}


// Could not insert EmployeeTitle
public static DaoException couldNotInsertEmployeeTitle(Throwable cause) {
   return new DaoException("Could not insert EmployeeTitle. EmployeeTitle must consist of valid characters (letters, spaces, and symbols)", cause);
}
...
public static DaoException couldNotInsertProjectNo(Throwable cause) {
   return new DaoException("Could not insert ProjectNo. ProjectNo must start with 'P' followed by 0-4 digits (e.g., P1, P123).", cause);
}


// Could not insert ProjectName
public static DaoException couldNotInsertProjectName(Throwable cause) {
   return new DaoException("Could not insert ProjectName. ProjectName must consist of valid characters (letters, spaces, and symbols)", cause);
}
...
public static DaoException couldNotInsertMilestoneNo(Throwable cause) {
   return new DaoException("Could not insert MilestoneNo. MilestoneNo must start with 'M' followed by 0-4 digits (e.g., M1, M123).", cause);
}


// Could not insert MilestoneDescription
public static DaoException couldNotInsertMilestoneDescription(Throwable cause) {
   return new DaoException("Could not insert MilestoneDescription. MilestoneDescription must consist of valid characters (letters and symbols).", cause);
}
