...
public class ProjectEditConsultantHoursViewController implements Initializable {
    ...
    void handleBtnSave(ActionEvent event) {
        try {
            ...
            workDao.updateConsultantHoursOnProject(project.getProjectNo(), consultant.getEmployeeNo(), hoursWorked,
                    weeklyHours);
            ...
            if (projectViewController != null) {
                ...
                throw new DaoException(
                        "Could not update consultant hours on project. Project view controller is null.");
            }
            ...
            // Update total hours and number of consultants
            if (mainViewController != null) {
                mainViewController.updateConsultantsTableView();
